...
public class ManageEastAsiaCountries {
        ...
        while (true) {
            try {
                ...
                return result;
                    ...
                    System.err.print("Entered num must be greater than 0");
            } catch (NumberFormatException e) {
    ...
    //display infomation of last country input
    public static void printLastInputCountry(ArrayList<Country> lc) {
        System.out.printf("%-10s%-25s%-20s%-25s\n", "ID", "Name", "Total Area", "Terrain");
        lc.get(lc.size()-1).display();
        }
    
    //display infomation of fisrt country input
    public static void printFirstInputCountry(ArrayList<Country> lc) {
        System.out.printf("%-10s%-25s%-20s%-25s\n", "ID", "Name", "Total Area", "Terrain");
        lc.get(0).display();
        }
    ...
    public static void printCountrySorted(ArrayList<Country> lc) {
        ArrayList<Country> ls = new ArrayList<Country>(lc);
        Collections.sort(ls);
        System.out.printf("%-10s%-25s%-20s%-25s\n", "ID", "Name", "Total Area", "Terrain");
